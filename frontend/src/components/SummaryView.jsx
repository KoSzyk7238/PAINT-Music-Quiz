...
export default function SummaryView({ sessionSummary, currentQuiz, onFinish, isLoggedIn, onLoginClick, onRegisterClick }) {
    ...
    return (
        <div className="flex flex-col items-center max-w-4xl mx-auto w-full bg-gray-900/40 p-10 rounded-3xl border border-white/5 animate-in fade-in slide-in-from-bottom-10 duration-700 relative">
            ...
            {showEncourageModal && (
                <div className="fixed inset-0 bg-black/90 backdrop-blur-md z-50 flex items-center justify-center p-4">
                    <div className="bg-gray-950 border border-green-500/30 p-10 rounded-[32px] max-w-md w-full flex flex-col gap-6 shadow-[0_0_50px_rgba(34,197,94,0.15)] animate-in zoom-in-95 duration-200 text-center relative">
                        <button
